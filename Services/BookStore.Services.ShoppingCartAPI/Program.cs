...
//SeriLog Setttings
Log.Logger = new LoggerConfiguration().MinimumLevel.Information().WriteTo.File("log/BookStoreShoppýngCartApi.txt", rollingInterval: RollingInterval.Day).CreateLogger();
