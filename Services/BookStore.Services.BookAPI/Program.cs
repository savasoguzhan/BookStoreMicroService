...
using BookStore.Services.BookAPI.Extension;
...
//SeriLog Setttings
Log.Logger = new LoggerConfiguration().MinimumLevel.Information().WriteTo.File("log/BookStoreBookApi.txt", rollingInterval: RollingInterval.Day).CreateLogger();
